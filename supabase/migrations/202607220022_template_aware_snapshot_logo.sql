...
-- Le logo figé dans l'instantané de finalisation était toujours la variante
-- claire, indépendamment du modèle choisi. On calcule désormais le
-- template_payload avant le logo pour pouvoir respecter
-- logo_settings.use_alternate (bascule vers la variante sombre) et
-- logo_settings.show (aucun logo figé si explicitement masqué).
