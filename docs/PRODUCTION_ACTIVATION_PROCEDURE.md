...
Vérifiez que la liste se termine par `202607290112_knowledge_access_indexing_and_review.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607290112"}
```
