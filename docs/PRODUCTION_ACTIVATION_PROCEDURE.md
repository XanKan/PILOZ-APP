...
Vérifiez que la liste se termine par `202607290117_update_crm_prospect_company_person_fields.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607290117"}
```
