...
Vérifiez que la liste se termine par `202607290104_onboarding_numbering_controls.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607290104"}
```
