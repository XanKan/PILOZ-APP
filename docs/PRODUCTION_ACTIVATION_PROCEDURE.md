...
Vérifiez que la liste se termine par `202607290103_simplified_company_provisioning.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607290103"}
```
