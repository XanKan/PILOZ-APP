...
Vérifiez que la liste se termine par `202607270094_crm_party_official_company_details.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607270094"}
```
