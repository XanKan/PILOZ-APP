...
Vérifiez que la liste se termine par `202607220047_fiscal_maintenance_automation.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607220047"}
```
