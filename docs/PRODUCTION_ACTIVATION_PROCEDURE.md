...
Vérifiez que la liste se termine par `202607290113_help_support_reliability.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607290113"}
```
