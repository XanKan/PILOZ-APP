...
Vérifiez que la liste se termine par `202607270097_superpdp_sandbox_connector.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607270097"}
```
