...
Vérifiez que la liste se termine par `202607290105_client_primary_contact_creation.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607290105"}
```
