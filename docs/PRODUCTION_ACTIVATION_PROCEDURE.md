...
Vérifiez que la liste se termine par `202607280102_dashboard_pipeline_widget_preferences.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607280102"}
```
