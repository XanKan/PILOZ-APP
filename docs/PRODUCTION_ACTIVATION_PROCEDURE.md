...
Vérifiez que la liste se termine par `202607290115_help_academy_documentation.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607290115"}
```
