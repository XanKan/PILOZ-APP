...
Vérifiez que la liste se termine par `202607270095_fiscal_archive_kms_signatures.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607270095"}
```
