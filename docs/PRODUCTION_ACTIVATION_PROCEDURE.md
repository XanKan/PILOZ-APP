...
Vérifiez que la liste se termine par `202607310120_activities_knowledge_base.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607310120"}
```
