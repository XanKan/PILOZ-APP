...
Vérifiez que la liste se termine par `202607230049_client_workspace.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607230049"}
```
