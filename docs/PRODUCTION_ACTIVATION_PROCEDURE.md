...
Vérifiez que la liste se termine par `202607290116_prospect_official_company_and_person_fields.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607290116"}
```
