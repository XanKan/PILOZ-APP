...
Vérifiez que la liste se termine par `202607230048_invoice_issue_date_chronology.sql` et qu’aucune migration inattendue n’est annoncée.
...
```json
{"ok": true, "schema_version": "202607230048"}
```
