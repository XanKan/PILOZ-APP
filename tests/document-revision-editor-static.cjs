...
assert(indexHtml.includes('erp-app.js?v=20260804.perf-refresh1'), 'Le cache erp-app doit être invalidé.');
assert(indexHtml.includes('erp-document-editor-v2.js?v=20260804.perf-refresh1'), 'Le cache de l’éditeur V2 doit être invalidé.');
