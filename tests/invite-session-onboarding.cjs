...
const onboardingStyles=fs.readFileSync('assets/css/phase1-foundation.css','utf8');
...
(async()=>{
  ...
  assert(index.includes('phase1-foundation.css?v=20260731.5'),'Le cache des styles de l’onboarding doit être invalidé.');
