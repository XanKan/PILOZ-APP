...
(async()=>{
  ...
  assert(index.includes('professional-onboarding.js?v=20260729.5'),'Le cache du module d’onboarding doit être invalidé.');
  assert(index.includes('phase1-foundation.css?v=20260729.2'),'Le cache des styles de l’onboarding doit être invalidé.');
