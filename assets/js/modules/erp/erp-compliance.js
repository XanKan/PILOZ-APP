 ...
 function renderAbout(s){
  ...
  document.getElementById('main').innerHTML=header('À propos et conformité','Version, périmètre de preuve et validations externes restantes.')+
   `<div class="modern-settings-grid">
    <section class="phase1-card"><h2>Version de Piloz</h2><dl class="company-summary-list"><div><dt>Application</dt><dd>0.9.0-compliance.30</dd></div><div><dt>Schéma attendu</dt><dd>202607260079</dd></div><div><dt>Moteur de calcul</dt><dd>financial-v2-deposit-deduction</dd></div><div><dt>Générateur PDF</dt><dd>pdf-v3-cgv</dd></div><div><dt>Déploiement</dt><dd>26 juillet 2026</dd></div></dl></section>
